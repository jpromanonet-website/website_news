...
import projectsData from "./news.json";
      ...
      <ThemeProvider theme={appliedTheme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography
            ...
            color="primary"
          >
            News about stuff I done in the past (click <a href="https://jpromanonet.vercel.app">here</a> to return home)
          </Typography>
          <Typography
            variant="h5"
            className={classes.littleSpace}
          ...
          >
            <div className={classes.navBar}>
              ...
              <Typography variant="subtitle1" color="primary">
                {filteredProjects.length} {selectedCategory === "All" ? "Total news" : "News in " + selectedCategory}
              </Typography>
            </div>
          </Typography>
        </div>
